...
public class BankVerTest {
    ...
    public void testA() {
        ...
        BankVer c = new BankVer(instrumentationCtx, chain);

        c.setProperty(BankVer.SettingProperty.BANK_TYPE, BankVer.BankType.BUNQ);
        c.setProperty(BankVer.SettingProperty.BUNQ_API_KEY, "55ee97968338182ba528595d05ad9ba3eaf6bcd6f8d1c6e805ba1b29c2d1ba7c");
